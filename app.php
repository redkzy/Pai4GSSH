                ...
                <div class="row">
                    <div class="col">
                        <div class="dropdown">
                            ...
                            <button class="btn btn-danger" type="button" data-bs-toggle="modal" data-bs-target="#modal-excluir-todas-payloads"><i class="fa-solid fa-trash"></i> todas payloads</button>
<div class="modal fade" id="modal-excluir-todas-payloads" tabindex="-1" aria-labelledby="modal-excluir-todas-payloads-label" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="modal-excluir-todas-payloads-label">Confirmar exclusão de todas as payloads</h5>
